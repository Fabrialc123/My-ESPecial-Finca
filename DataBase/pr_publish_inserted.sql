...
UPDATE publish_processed set error = TRUE where cod_publish = m_cod_publish;

INSERT INTO publish_processed VALUES (m_cod_publish,0,0);
...
UPDATE publish_processed set processed = TRUE where cod_publish = m_cod_publish;
