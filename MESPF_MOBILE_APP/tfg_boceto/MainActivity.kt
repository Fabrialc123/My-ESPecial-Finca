...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.login.setOnClickListener{
            if(binding.ipMqtt.text.isEmpty() || binding.usernameMqtt.text.isEmpty() ||
                ...
                editor.putString("MQTT_SERVER", MQTT_SERVER)
    ...
    private fun checkLoginFile(): Boolean{
        ...
        //if (sharedPreferences.contains("ip")) {
            ...
            binding.textInicioSesion.text = "Existe un usuario guardado"
        ...
        if(ip != null)
            ...
            binding.textInicioSesion.text = "No hay ningun usuario guardado"
            return false
        }
        return false
    }
        ...
        if(cursor.moveToFirst()){
            ...
            do{
                ...
                if(name != ""){
                    ...
                    val newEsp = Esp32(esp_name,esp_alias, temperat, humidity, wat_levl, gas_c, hum_ter);
    ...
    private fun initRecyclerView() {
        ...
        adapter = EspAdapter(espList = esp32MutableList, onClickListener = { posicion ->
