...
class EspAdapter(
                                                        private val espList: List<Esp32>,
                                                        private val onClickListener: (Int) -> Unit,
                                                        private val onClickRefresh: (Int) -> Unit,
                                                        private val onclickStatus: (Int) -> Unit) : RecyclerView.Adapter<EspViewHolder>() {
    ...
    override fun onBindViewHolder(holder: EspViewHolder, position: Int) {
        ...
        holder.render(item, onClickListener, onClickRefresh, onclickStatus)
        //holder.updateView()
