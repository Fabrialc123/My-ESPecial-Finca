...
class MqttService : Service() {
    ...
    */
        //val notificacionMan = getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
        //notificacionMan.cancel(NOTIFICATION_ID)
        //stopForeground(true)
    ...
    private fun showMessageNotification(message: String?) {
        ...
        val vistaExpandida = NotificationCompat.BigTextStyle()
            .bigText(message)
            .setBigContentTitle("MESPF ALARMA")
            .setSummaryText("Alarma")
